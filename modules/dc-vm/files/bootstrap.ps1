...
if ( $op -Contains $forest ){
    ...
    $user5 = @{FirstName = "Jason"; LastName = "Lindqvist"; usernm = "${winrm_username}"; ou = $myou; pcred = "${winrm_password}"}
    $ADUsers += $user5
    ...
    Add-ADGroupMember -Identity "Domain Admins" -Members "${winrm_username}"
