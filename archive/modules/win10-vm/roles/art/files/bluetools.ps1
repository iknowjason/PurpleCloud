...
#(New-Object System.Net.WebClient).DownloadFile('https://github.com/iknowjason/BlueTools/blob/main/velociraptor-v0.5.0-1-windows-amd64.msi.zip?raw=
#true', 'C:\terraform\velociraptor-windows-msi.zip')
...
#Set-Content -Path C:\Users\RTCAdmin\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1 -Value 'IEX (New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/redcanaryco/invoke-atomicredteam/master/install-atomicredteam.ps1")'
Set-Content -Path C:\Users\RTCAdmin\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1 -Value $script_contents 
#Add-Content -Path C:\Users\RTCAdmin\Documents\WindowsPowerShell\Microsoft.Powershell_profile.ps1 -Value 'Install-AtomicRedTeam -Force'
